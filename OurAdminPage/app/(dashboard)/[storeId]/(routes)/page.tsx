  ...
  return (
    <div className="flex-col">
      <div className="flex-1 space-y-4 p-8 pt-6">
        <Heading title="Dashboard" description={t('menu.description')}  />
        <Separator />
        <div className="grid gap-4 grid-cols-3">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('overview.totalRevenue')}
              </CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{t('overview.productsInStock')}</CardTitle>
        ...
        <Card className="col-span-4">
          <CardHeader>
            <CardTitle>{t('overview.overwiev')}</CardTitle>
          </CardHeader>
